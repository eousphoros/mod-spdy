...
OPENSSL_SRC_TGZ_URL="https://www.openssl.org/source/openssl-1.0.2a.tar.gz"
...
download_file $OPENSSL_SRC_TGZ_URL $OPENSSL_SRC_TGZ a06c547dac9044161a477211049f60ef
